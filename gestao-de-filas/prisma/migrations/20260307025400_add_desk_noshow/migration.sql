...
CREATE TABLE "Desk" (
    ...
    CONSTRAINT "Desk_queueId_fkey" FOREIGN KEY ("queueId") REFERENCES "Queue" ("id") ON DELETE SET NULL ON UPDATE CASCADE
);
...
INSERT INTO "new_Ticket" ("code", "createdAt", "id", "isPriority", "number", "priority", "queueId", "service", "status", "userId") SELECT "code", "createdAt", "id", "isPriority", "number", "priority", "queueId", "service", "status", "userId" FROM "Ticket";
DROP TABLE "Ticket";
